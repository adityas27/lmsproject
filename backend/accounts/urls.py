...
from .views import UserDetailView, signup_view, update_profile, list_users, update_user_flags, submit_teacher_application, list_teacher_applications, update_application_status
urlpatterns = [
